        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-10">
          ...
          <div className="space-y-8 lg:col-span-4">
            ...
            <div className="space-y-5">
              ...
              <div>
                <p className="text-sm text-tgs-gray-text mb-1">Alamat</p>
                <div className="flex items-start gap-2 text-tgs-gray-text text-sm">
                  <MapPin className="w-4 h-4 shrink-0 mt-0.5" />
                  <span className="leading-relaxed">
                    Jl. Kp. Jemb. Jl. Marzuki 2 No.20, RT.6/RW.17, Penggilingan, Kec. Cakung, Jakarta Timur 13940
                  </span>
                </div>
              </div>

        ...
        <div className="animate-fade-in w-[340px] rounded-2xl shadow-2xl overflow-hidden border border-tgs-gray-medium/50 mb-2">
          ...
          >
            ...
            <div className="bg-white rounded-lg rounded-tl-none p-3 shadow-sm max-w-[85%] relative">
              ...
              <p className="text-[13px] text-gray-800 leading-relaxed">
                ...
                Ada yang bisa kami bantu? Jangan ragu langsung chat ya...
              </p>
          ...
          <div className="bg-white px-4 py-3 border-t border-gray-200">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-[#25d366] hover:bg-[#1ebe5b] text-white w-full py-2.5 rounded-lg text-sm font-semibold transition-colors shadow-sm"
            >
